...
For this reason, we decide to conduct an experiment to see if political divide and rise of pessimism were as accurate as the media portrayed. We selected four topics, each of which has considerable relevance to a person living in the United States and is neutral across political lines. By inserting Trump into these topics, we hope to address the media portrayal in two-fold:

* Political polarization: Are we (as America) divided enough to have different level of optimism regardless of Trump?
* Rise of pessimism due to Trump: Is the rise of pessimism strong enough that anything he says or do will trigger a level of anger regardless of the person's political affiliation?
